...
public class OrderPartyCommand extends CommandBase {

    public OrderPartyCommand(@NonNullDecl String name, @NonNullDecl String description) { super(name, description); }
