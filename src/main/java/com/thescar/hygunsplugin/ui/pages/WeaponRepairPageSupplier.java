...
public class WeaponRepairPageSupplier implements OpenCustomUIInteraction.CustomPageSupplier {
	@Override
	public CustomUIPage tryCreate(Ref<EntityStore> ref, ComponentAccessor<EntityStore> accessor, PlayerRef playerRef,
		...
		return new WeaponRepairPage(playerRef, PlayerInventoryAccess.getCombinedArmorHotbarUtilityStorage(player), heldItemContext);
	}
}
